...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "objecttypes"),
        "USER": os.getenv("DB_USER", "objecttypes"),
        "PASSWORD": os.getenv("DB_PASSWORD", "objecttypes"),
...
ELASTIC_APM = {
    "SERVICE_NAME": os.getenv("ELASTIC_APM_SERVICE_NAME", "Objecttypes API"),
