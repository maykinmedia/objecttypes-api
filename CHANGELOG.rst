...
* [maykinmedia/open-objects#18] Add booleanfield that indicates whether his object should be linkable to zaken
...
.. note::
    ...
    - Metrics now exposed include:
        ...
        - **CRUD** operations for the following endpoint:
...
* [maykinmedia/commonground-api-common#134] Ensure exceptions get send to Sentry
